...
(1, 'wall', 'Wall', '#000000', NULL, 0),
(2, 'floor', 'Florr', '#FFFFFF', NULL, 0),
(3, 'exit', 'Sleeping area', '#666666', NULL, 0),
(4, 'entrance', 'Entrace/Exit', '#6699CD', NULL, 0),
(5, 'stage', 'Stage', '#AA00AA', NULL, 0),
(6, 'seat_available', 'Available seat', '#00FF00', '#00aa00', 1),
(7, 'seat_taken', 'Taken seat', '#FF0000', '#aa0000', 1),
(8, 'seat_yours', 'Your seat', '#FFFF00', NULL, 1),
(9, 'wc', 'WC', '#FF6347', '#FF6347', 0),
(10, 'table', 'Table', '#6d5201', '#6d5201', 0);
