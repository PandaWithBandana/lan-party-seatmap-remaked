...
class DAL {
    ...
    public function __construct($config) {
        ...
        if ($this->connection->connect_errno) {
            exit('<img src="install/header.gif" border="0" alt="header" />
			<div class="isa_error">
   <i class="fa fa-times-circle"></i>
   Please input the database information in the config.php file in your file directory! Error reason: Connection to database failed
</div>');
        }
